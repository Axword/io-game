export const WEAPONS = {
    ...
    fireball: {
        ...
        manual: false,
        cooldown: 1.5,
        stats: { dmg: 45, bSpd: 15, bCnt: 1, bSz: 1.2, explosion: 80, pierce: 0 },
    ...
    knife: {
        ...
        manual: false,
        cooldown: 0.3,
        stats: { dmg: 18, bSpd: 35, bCnt: 1, bSz: 0.8, pierce: 1 },
        allowedUpgrades: ['damage', 'projectileSpeed', 'projectileCount', 'attackSpeed', 'pierce']
    },
    laser: {
        name: 'Laser',
        icon: '📡',
        ...
        manual: false,
        cooldown: 2.5,
        stats: { dmg: 60, duration: 1.5, width: 30, atkSpd: 1 },
        allowedUpgrades: ['damage', 'duration', 'projectileSize', 'attackSpeed', 'projectileCount']
    },
    poison: {
        name: 'Trucizna',
        icon: '☠️',
    ...
    meteor: {
        ...
        manual: false,
        cooldown: 4.0,
        stats: { dmg: 100, bCnt: 1, impact: 200, bSz: 2, pierce: 999 },
        allowedUpgrades: ['damage', 'projectileCount', 'projectileSize', 'attackSpeed', 'explosion']
    }
};
